...
func (x *JobCompletion) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_app_proto_rawDesc = []byte{
	...
	,
...
var file_app_proto_goTypes = []interface{}{
	...
	(*Job)(nil),           // 1: Job
	(*JobCompletion)(nil), // 2: JobCompletion
}
var file_app_proto_depIdxs = []int32{
	0, // 0: Master.RequestJob:input_type -> JobRequest
	1, // 1: Master.CompleteJob:input_type -> Job
	1, // 2: Master.RequestJob:output_type -> Job
	2, // 3: Master.CompleteJob:output_type -> JobCompletion
...
type MasterClient interface {
	...
	CompleteJob(ctx context.Context, in *Job, opts ...grpc.CallOption) (*JobCompletion, error)
}
...
func (c *masterClient) CompleteJob(ctx context.Context, in *Job, opts ...grpc.CallOption) (*JobCompletion, error) {
...
type MasterServer interface {
	...
	CompleteJob(context.Context, *Job) (*JobCompletion, error)
}
...
func (*UnimplementedMasterServer) CompleteJob(context.Context, *Job) (*JobCompletion, error) {
...
func _Master_CompleteJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServer).CompleteJob(ctx, req.(*Job))
	}
	return interceptor(ctx, in, info, handler)
}
